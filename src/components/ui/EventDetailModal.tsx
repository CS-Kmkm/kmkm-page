      ...
      >
        ...
        <div className="flex items-start justify-between p-6 border-b border-gray-200">
          ...
          <button
            ref={closeButtonRef}
            onClick={onClose}
            className="flex-shrink-0 text-gray-400 hover:text-gray-600 transition-colors p-2 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            aria-label="モーダルを閉じる"
          >
            <svg
              className="w-5 h-5"
          ...
          <div className="space-y-4">
            ...
            {event.relatedLinks && event.relatedLinks.length > 0 && (
              <div className="space-y-2">
                <h4 className="text-sm font-medium text-gray-900">関連リンク</h4>
            ...
            {event.tags && event.tags.length > 0 && (
              <div className="space-y-2">
                <h4 className="text-sm font-medium text-gray-900">タグ</h4>
            ...
            {filteredEvents.length > 1 && (
              <>
                <button
                  ...
                  className="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  aria-label="前のイベント"
                >
